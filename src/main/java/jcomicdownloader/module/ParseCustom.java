...
public class ParseCustom extends ParseOnlineComicSite
{
...
//        ScriptEngine engine = sem.getEngineByName("js");
        ...
        try{
            engine.eval( "function getRegexs(){ return [{\"(?s).*dm5.com(?).*\",\"(?s).*dm9.com(?).*\"} ];} ");
            Object o = engine.eval("getRegexs();");
            regexs = (String[])o;
        }catch (Exception e){
        }
    }

    public ParseCustom( String webSite, String titleName )
    {
        this();
